...
p0_pitch_module = 2.5;
p0_face_width = 5.0;
p0_pressure_angle = 20.0;
p1_teeth = 40;
p1_pitch_module = 2.5;
p1_face_width = 5.0;
p1_pressure_angle = 20.0;

module part_0() {
  circular_pitch_mc = 180 * p0_pitch_module;
  linear_extrude(height = p0_face_width, center = true, convexity = 10)
    gear(number_of_teeth = p0_teeth, circular_pitch = circular_pitch_mc, pressure_angle = p0_pressure_angle);
}

module part_1() {
  circular_pitch_mc = 180 * p1_pitch_module;
  linear_extrude(height = p1_face_width, center = true, convexity = 10)
    gear(number_of_teeth = p1_teeth, circular_pitch = circular_pitch_mc, pressure_angle = p1_pressure_angle);
}
